...
for iE_p, E_p in enumerate([1, 3, 10]):
    ...
    #plt.plot(theta_p, eta_p, '--', color=color[iE_p], label=r'$\eta_{e^+},\ E_{e^+} = %d$ GeV' % E_p)
    #plt.plot(theta_p, eta_e, '-',  color=color[iE_p], label=r'$\eta_{e^-},\ E_{e^+} = %d$ GeV' % E_p)
    ...
    plt.plot(theta_p, theta_p_lab, '--', color=color[iE_p], label=r'$\theta_{e^+},\ E_{e^+} = %d$ GeV' % E_p)
    plt.plot(theta_p, theta_e_lab, '-',  color=color[iE_p], label=r'$\theta_{e^-},\ E_{e^+} = %d$ GeV' % E_p)
